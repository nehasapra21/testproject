...
function TermsAndUse() {
  return (
    <div className='container pt-3 pb-5 white--text'>
      <h2>
        <strong>Terms and Conditions</strong>
      </h2>

      <p>Welcome to fakenewsornot.in!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Fake news or not's Website, located at www.fakenewsornot.in.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use fakenewsornot.in if you do not agree
      ...
      <p>
        We employ the use of cookies. By accessing fakenewsornot.in, you agreed
        to use cookies in agreement with the Fake news or not's Privacy Policy.{' '}
      </p>
      ...
      <p>
        Unless otherwise stated, Fake news or not and/or its licensors own the
        intellectual property rights for all material on fakenewsornot.in. All
        intellectual property rights are reserved. You may access this from
        fakenewsornot.in for your own personal use subjected to restrictions set
        in these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from fakenewsornot.in</li>
        <li>Sell, rent or sub-license material from fakenewsornot.in</li>
        <li>Reproduce, duplicate or copy material from fakenewsornot.in</li>
        <li>Redistribute content from fakenewsornot.in</li>
      </ul>
      ...
      <p>
        ...
        exchange opinions and information in certain areas of the website. Fake
        news or not does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Fake news or not,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, Fake news or not
      ...
      <p>
        Fake news or not reserves the right to monitor all Comments and to
      ...
      <p>
        You hereby grant Fake news or not a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Fake news or not; and (d) the
      ...
      <p>
        ...
        e-mail to Fake news or not. Please include your name, your organization
      ...
      <p>
        No use of Fake news or not's logo or other artwork will be allowed for
